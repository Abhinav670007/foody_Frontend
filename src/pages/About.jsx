    ...
    <div className='pt-24 mb-3'>
      <Row className='justify-center m-auto'>
          <Col sm={12} md={6} className="">
              <img src={about} alt="" className='w-96 h-80 sm:ms-72'/>
          </Col>
          <Col sm={12} md={6} className="">
            <p className='about text-3xl font-bold justify-start'>WE ARE FRESHSHOP</p>
