  ...
  return (
    <div className="bg-gray-400 h-[550px]">
      <center className="pt-20">
        <form
          className="items-center bg-gradient-to-r from-cyan-500 to-teal-800 border shadow rounded max-w-96 w-5/6 px-3 flex-column d-flex form-control pb-3 mt-2"
          onClick={handlesubmit}
        >
          <h1 className="mt-3 text-2xl">Sign up</h1>
          <input
          ...
          <button
            onClick={sendData}
            className="btn btn-success  md:w-32 text-center m-auto mt-4 mb-1"
          >
            Sign up
          </button>
